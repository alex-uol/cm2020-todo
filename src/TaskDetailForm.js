...
function TaskDetailForm({
  ...
  const removeTag = (e) => {
    setCurrentTask({
      ...currentTask,
      tags: currentTask.tags.filter((n) => n != e.target.value),
    });
  };
    ...
    function drawTag(tag) {
      return (
        <div className="list-item" key={tag.id}>
          ...
          <div>
            <button className="warning" value={tag.id} onClick={removeTag}>
              Delete
            </button>
          </div>
        </div>
  ...
  return (
    <div className="task-detail-form">
      ...
      <div className="tags-container">{drawTagsContainer()}</div>
